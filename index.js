...
console.log(
  ...
  chalk.black.bold.bgGreenBright(
    "LEAPY YEAR (See whether you were born in a leap year or not!"
  ),
  "\n-------------\n"
);
...
console.log(
  chalk.white.bold("Info about leap year"),
  chalk.blue.bold(
    "\n1. Leap year is a year which consists of 366 days in a year.\n2. In Leap year february month has 29 days.\n"
  )
);
console.log(
  chalk.white.bold("How Leap Year is Calculated"),
  chalk.blue.bold(
    "\n1. If a number is mutiple of 4.\n2. If a number is mutiple of 400.\n3. If a number is not a mutiple of 100"
  ),
  chalk.green.bold(
...
var birthYear = readlineSync.question(
...
function dateValidation() {
  if (isNaN(birthYear) || birthYear < 0) {
    console.log(
      chalk.bold.bgBlackBright.white(
